...
function Main() {
  return (
    <>
      ...
      <h1 className="flex font-['FinkHeavy'] justify-center p-3 pt-5 text-4xl">Today's Birthday</h1>
        ...
        <Card style={{ width: "18rem" }}>
          ...
          <Card.Body>
            ...
            <Card.Text className="font-bold">
              ...
              Saying: <span className="font-light">"Don't punch your nose to spite your face."</span> <br/>
            </Card.Text>
          </Card.Body>
        </Card>
      </div>
